...
public:
  MainWindow() :
    ...
    builder(Gtk::Builder::create_from_file("padapp.ui")) {
...
void on_app_activate()
{
  ...
  try
  {
    refBuilder->add_from_file("padapp.ui");
  }
  ...
  pDialog = refBuilder->get_widget<Gtk::Window>("GtkWindow");
  if (!pDialog)
  {
...
{
  auto app = Gtk::Application::create("io.github.zamonary1.padapp");
